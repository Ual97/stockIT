window.addEventListener('load', function() {
  ...
  for (let element of elements) {
    ...
    element.addEventListener('click', async function () { //asyc function which allows make await returns
      ...
      const colReservedInput = document.createElement("input");
      colReservedInput.setAttribute("type", "number");
      colReservedInput.setAttribute("placeholder", "");
      colReservedInput.setAttribute("name", "qty_reserved");
      colReservedInput.setAttribute("id", "qty_reserved");
      colReservedInput.setAttribute("value", data.qty_reserved);
      colReservedValue.appendChild(colReservedInput);
